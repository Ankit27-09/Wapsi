...
export default tseslint.config(
  {
    ignores: [
      ...
      'eslint.config.js',
      'vitest.config.ts',
      // Generated by Next on every build, and it carries a triple-slash reference the rules
      // below correctly object to. Linting a file nobody writes is noise.
      'apps/web/next-env.d.ts',
      // Build configuration, not application code: outside every tsconfig, so type-aware
...

  {
    languageOptions: {
      parserOptions: {
        ...
        // Two projects, because the web console is a different kind of program: JSX, DOM
        // libs, bundler module resolution. Type-aware linting needs the right one per file,
        // and pointing both at a single config would either fail to parse the .tsx or force
        // DOM types onto the workspace packages.
